 ...
 */
final class RejectAuthorisationHandler implements HandlesPostRequest
{
    /**
     * @var CommandBus
     */
     ...
     * @param AuthorisationRepository $authorisationRepository
     */
    public function __construct(CommandBus $commandBus, AuthorisationRepository $authorisationRepository)
    {
    ...
    public function handle( ProvidesWriteRequestData $request )
    {
        ...
        $this->commandBus->dispatch(RejectAuthorisation::from(
